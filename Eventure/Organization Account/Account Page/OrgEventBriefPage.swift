...
//
//
//    private var eventUUIDList: Set<String> = ["testEvent"]//FIXME: retrieve Org specific event
...
//
//        let detailPage = OrgEventBriefPage()
...
//        if !Organization.current!.interestedEvents.contains(event.uuid) {
