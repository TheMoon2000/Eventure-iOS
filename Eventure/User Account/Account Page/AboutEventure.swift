...
class AboutEventure: UIViewController {
    ...
    let icon: UIImageView = {
        ...
        iv.image = #imageLiteral(resourceName: "user_default")
    ...
    override func viewDidLoad() {
        ...
        icon.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 50).isActive = true
